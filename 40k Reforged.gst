...
<gameSystem id="sys-c49b-9f87-36f1-c9b5" name="40k Reforged" battleScribeVersion="2.03" revision="56" type="gameSystem" xmlns="http://www.battlescribe.net/schema/gameSystemSchema">
  <categoryEntries>
  ...
  <sharedSelectionEntries>
    <selectionEntry type="upgrade" import="true" name="Battle Size" hidden="false" id="564e-fbc6-5266-3ea4" collective="false">
      ...
      <selectionEntryGroups>
        <selectionEntryGroup name="Battle Size" id="b960-4789-a3a6-59cb" hidden="false" collective="false" import="true" defaultSelectionEntryId="baf8-997f-e323-a090">
          <constraints>
    ...
    <selectionEntry type="upgrade" import="true" name="Dozer Blade" hidden="false" id="73da-e53b-4390-b808">
      ...
      <infoLinks>
        <infoLink name="Walker" id="db79-1e6c-0728-38d0" hidden="false" type="rule" targetId="4100-8e8c-47a5-3a15"/>
      </infoLinks>
    </selectionEntry>
    ...
    <selectionEntry type="upgrade" import="true" name="Plasma Cannon" hidden="false" id="597d-3cc2-8209-d3d1">
      <profiles>
        <profile name="Plasma Cannon" typeId="2dff-53d0-6d25-8c59" typeName="Weapon" hidden="false" id="c516-224c-dfa7-2098">
          <characteristics>
            <characteristic name="Tp" typeId="6c1c-7d1d-c8b0-33ec">Hv</characteristic>
            <characteristic name="A" typeId="13c5-f234-c120-afc3"/>
            <characteristic name="WS" typeId="459f-6890-e77f-b62f"/>
    ...
    <selectionEntry type="upgrade" import="true" name="Combi-Grav" hidden="false" id="bcad-e810-d021-aa20">
      <profiles>
        <profile name="Combi-Grav" typeId="2dff-53d0-6d25-8c59" typeName="Weapon" hidden="false" id="0864-4206-a267-14b2">
          <characteristics>
            <characteristic name="Tp" typeId="6c1c-7d1d-c8b0-33ec">Aslt</characteristic>
            <characteristic name="A" typeId="13c5-f234-c120-afc3"/>
            <characteristic name="WS" typeId="459f-6890-e77f-b62f">3+</characteristic>
